...
pub fn stage() -> AdHoc {
    AdHoc::on_ignite("Diesel SQLite Stage", |rocket| async {
        ...
        .mount("/api/user", routes![crate::endpoint::user::user_list, crate::endpoint::user::user_create, options_handler])
        .mount("/api/network", routes![crate::endpoint::network::network_list, options_handler])
        .mount("/api/process", routes![crate::endpoint::process::process_list, options_handler])
