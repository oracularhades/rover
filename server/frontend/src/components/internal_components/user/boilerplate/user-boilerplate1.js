    ...
    return (
        <div className='user_boilerplate1'>
            <div className='user_boilerplate1_user_details'>
                <img style={{ width: 85, height: 85 }} src="https://cdn.bsky.app/img/avatar/plain/did:plc:wtdzzfgzjpirnk5wvpjutqoy/bafkreic5ffd2emwnoeyh5kwwipjrpdaizgbwvkcv45esphgyudvv3jimca@jpeg"/>
                <div className='user_boilerplate1_user_details_metadata'>
                    <h2 className='user_boilerplate1_user_details_metadata_full_name'>John Doe</h2>
                    <p className='user_boilerplate1_user_details_metadata_email'>john.doe@example.com</p>
